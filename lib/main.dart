import 'package:couchbase_test/app_database.dart';
...
class _MyAppState extends State<MyApp> {
  ...
  Future<void> initPlatformState() async {
    ...
    AppDatabase.instance.login("username", "password");
  }
      ...
      home: Scaffold(
        ...
        floatingActionButton: FloatingActionButton(
          onPressed: () {
            ...
            map["name"] = "mark";
            map["number"] = 1;
            map["createdDate"] = DateTime.now().millisecondsSinceEpoch;
            AppDatabase.instance.createDocument(map);
          },
        ),
      ),
    );
